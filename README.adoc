...
[source,bash]
../ansible/files/dockerStart.sh
----
include::./ansible/files/dockerStart.sh[]
----

[source,bash]
../ansible/files/dockerStop.sh
----
include::./ansible/files/dockerStop.sh[]
----

You should be able to access:

- Traefik console: http://localhost:8888
- Bonita: http://bonita.localhost:85/bonita
- Swagger UI: http://swagger.localhost:85
- Redoc UI: http://redoc.localhost:85
